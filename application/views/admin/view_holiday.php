              ...
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php $c=1; foreach ($row->result() as $key) { ?>
                   <tr>
                      <td><?=$c++?></td>                      
                      <td><?=$key->holiday_title?></td>
                      <td><?=$key->holiday_date?></td>                                      
                      <td><a href="<?php echo base_url('index.php/main_controller/holiday_editpage/'.urlencode(base64_encode($key->holiday_id))); ?>"><i class="fa fa-edit (alias)"></i>&nbsp;Edit</a></td>
