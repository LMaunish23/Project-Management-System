 ...
 <?php include('sidebar.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>       
        <small>View Admins Details</small>
      </h1>
      <ol class="breadcrumb">
                ...
                <tbody>
                  <?php $c=1; foreach ($row->result() as $key) { ?>
                   <tr>
                      ...
                      <td><?=$key->username?></td>                      
                      <td><?=$key->email?></td>                      
                      <td><a href="<?php echo base_url('index.php/main_controller/businessunit_editpage/'.urlencode(base64_encode($key->admin_id))); ?>"><i class="fa fa-edit (alias)"></i>&nbsp;Edit</a></td>
