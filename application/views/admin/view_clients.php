                ...
                <tbody>
                  <?php  $c=1; foreach ($row->result() as $key)  {  ?>
                   <tr>
                      ...
                      <td><?=$key->email?></td>
                      <td><?=$key->contactNo?></td>
                      <td><a href="<?php echo base_url('index.php/main_controller/client_editpage/'.urlencode(base64_encode($key->co_id))); ?>"><i class="fa fa-edit (alias)"></i>&nbsp;Edit</a></td>
