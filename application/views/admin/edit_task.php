  ...
  <div class="content-wrapper" style="overflow: auto;">
    ...
    <div class="col-md-6" style="margin-left: 12%;width: 75%">
          ...
          <div class="box box-info">
            ...
            ?>
            <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/main_controller/edit_task/'.$key->pt_id); ?>" enctype="multipart/form-data">
              <div class="box-body">    
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">                   
                      <select  name="whh"> 
                        ...
                        <?php $i = 1; while ($i < 100) { $a = explode(".", $key->estimatedTime); $i = sprintf('%02d',$i); ?>
                        <option value="<?php $a = explode(".", $key->estimatedTime); $a1 = sprintf('%02d',$a[0]); echo $a1;?>" <?php if($a1 == $i){ ?> selected <?php }?>><?php  echo $i; ?></option><?php $i++; } ?>            
                      </select>                  
                      <select name="wmm">
                        <option disabled="">mm</option>
                        <?php $i = 15; while ($i < 46) { $a = explode(".", $key->estimatedTime); ?>
                        <option value="<?php $a = explode(".", $key->estimatedTime); $a1 = sprintf('%02d',$a[1]); echo $a1;?>" <?php if($a1 == $i){ ?> selected <?php }?>><?php  echo $i; ?></option><?php $i = $i + 15; } ?>
                      </select> 
