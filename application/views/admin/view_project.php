...
echo date_format($date, 'd -m -Y'); ?></td>
                      ...
                      <td><a href="<?php echo base_url('index.php/main_controller/project_editpage/'.urlencode(base64_encode($key->project_id))); ?>"><i class="fa fa-edit (alias)"></i>&nbsp;Edit</a></td>
