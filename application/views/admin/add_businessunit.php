<html>
<head>
  <title>PMS | Add-Business Unit</title>
  ...
  <div class="content-wrapper" style="overflow: auto;">
    ...
    <div class="col-md-6" style="margin-left: 12%;width: 75%">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
      <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/main_controller/add_businessUnit'); ?>" enctype="multipart/form-data">
       <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Name<label class="impf">*</label></label>
                  <div class="col-sm-10">                     
                    <input type="text" class="form-control" name="bname" id="bname" required placeholder="Business Unit Name"><h6 class="error"><?php echo form_error('bname'); ?></h6>               
                  </div>
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">                     
                    <input type="text" class="form-control" name="bemail" id="bemail" placeholder="Enter.."><h6 class="error"><?php echo form_error('bemail'); ?></h6>               
                  </div>
                </div>               
                <div class="form-group">
