...
<head>
  ...
  <title>PMS | View-Announcement</title>
                ...
                <tbody>
                  <?php $c=1; foreach ($row->result() as $key) { ?>
                   <tr>
                      ...
                      <td><?=$key->an_date?></td>  
                      <td><?=$key->an_desc?></td>                                      
                      <td><a href="<?php echo base_url('index.php/main_controller/announcement_editpage/'.urlencode(base64_encode($key->an_id))); ?>"><i class="fa fa-edit (alias)"></i>&nbsp;Edit</a></td>
