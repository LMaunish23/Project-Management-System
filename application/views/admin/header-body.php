<header class="main-header">
    ...
    <a href="<?php $con = $_SESSION["admin_controller"]; echo base_url('index.php/'.$con.'/'); ?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>A</b>VI</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>AVI</b>pms</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url($_SESSION['admin_img']);?>" class="user-image" alt="User Image">
