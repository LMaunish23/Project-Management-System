              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">  
                    <div class="row">
                        <div class="col-xs-4">
                          <input type="text" id="hh"  value="<?php $a = explode(".", $key->estimatedTime); echo $a[0];?>" name="hh" class="form-control" placeholder="hh">
                        </div>
                        <div class="col-xs-4">
                          <input type="text" id="mm" onkeyup="addhour()" name="mm" class="form-control" value="<?php echo $a[1]; ?>" placeholder="mm">
                        </div>                        
                    </div>
                  </div>
                </div>              
