      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url('index.php/pmtl_controller/task_addpage'); ?>"><i class="fa fa-plus-circle"></i>Add Task</a></li>
            <li><a href="<?php echo base_url('index.php/pmtl_controller/task_viewpage'); ?>"><i class="fa fa-eye"></i>View Task</a></li>
          </ul>
        </li>
         <!-- <li class="treeview">
          <a href="#">
         ...
         <li>
          <a href="<?php echo base_url('index.php/pmtl_controller/project_viewpage'); ?>">
        ...
        <li class="treeview" style="display: block;">
          ...
          <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-plus-circle"></i>Add Announcement</a></li>
            <li><a href=""><i class="fa fa-eye"></i>View Announcement</a></li>            
          </ul>
        </li>            
        <li>
          <a href="<?php echo base_url('index.php/pmtl_controller/events'); ?>">
